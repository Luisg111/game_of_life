...
class MainView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => MainScreenBloc(), child: const MainScreen());
  }
}
...
class _MainScreenState extends State<MainScreen> {
  ...
  GridView buildBody(BuildContext context) {
      ...
      children: List.generate(sizeX * sizeY, (index) {
        ...
        return BlocBuilder<MainScreenBloc, MainScreenState>(
          ...
          return GameTile(
            onTap: () => context
                .read<MainScreenBloc>()
                .add(MainScreenTileKlicked(Coordinates(x: x, y: y))),
            ...
            children: [
              ...
              Slider(
                ...
                onChanged: (double value) {
                  context
                      .read<MainScreenBloc>()
                      .add(MainScreenAutoplaySpeedChanged(value.toInt()));
                },
              ...
              IconButton(
                ...
                onPressed: () =>
                    context.read<MainScreenBloc>().add(MainScreenPlayPressed()),
